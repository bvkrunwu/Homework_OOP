...
def another_product():
    return Product(
        name="iPhone 15 Pro Max", description="512GB, Space Black, LiDAR camera", price=210000.0, quantity=8
    )
...
def category(product_list):
    return Category(name="Телефоны", description="Современные смартфоны премиум-класса", products=product_list)
